...
CREATE TABLE IF NOT EXISTS users (
  ...
  role text not null,
  status text not null default 'approved', -- 'pending' for applicants, 'approved' for active users
  created_at timestamp with time zone default timezone('utc'::text, now()) not null
);

-- Note: If user table already exists, run this:
...
-- 4. Create the 'driver_applications' table
